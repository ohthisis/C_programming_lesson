...
void time_class_get_date(char last_record[20]);
...
void time_class_get_date(char last_record[20]){
   ...
   unsigned int get_day = char_to_interger_fun(day);
   printf("get day %u\n",get_day);
   ...
   unsigned int get_year=char_to_interger_fun(year);
   printf("year: %d",get_year);
}
